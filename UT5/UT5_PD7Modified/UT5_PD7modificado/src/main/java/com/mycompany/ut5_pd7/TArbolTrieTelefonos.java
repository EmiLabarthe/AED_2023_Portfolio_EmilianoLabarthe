...
public class TArbolTrieTelefonos implements IArbolTrieTelefonos {
    ...
    private HashMap<String, TArbolTrieTelefonos> triesPaises = new HashMap<>();

    
    public HashMap<String, TArbolTrieTelefonos> getMapTriesPaises(){
        return triesPaises;
    }
    ...
    public TArbolTrieTelefonos todasLasVentasPais(String prefijo, LinkedList<TAbonado> ventas){
        ...
        switch(prefijo){
            case "598": 
                triesPaises.put("Uruguay", triePais);
                break;
            case "596": 
                triesPaises.put("Martinica", triePais);
                break;
            case "054": triesPaises.put("Argentina", triePais);
        }
        return triePais;
    }
