...
public class UT5_PD7 {
    ...
    public static void main(String[] args){
        ...
        //Armo salida con datos recopilados
        ...
        System.out.println(ventasArgentina.getCantidadTelefonos());
        System.out.println(argentinaDesdeFebrero.size());
        ...
        i = 0;
        salidaEj2B[i++] = "Argentina," + Integer.toString(ventasArgentina.getCantidadTelefonos());
        salidaEj2B[i++] = "Uruguay," + Integer.toString(ventasUruguay.getCantidadTelefonos());
        salidaEj2B[i++] = "Martinica," + Integer.toString(ventasMartinica.getCantidadTelefonos());
